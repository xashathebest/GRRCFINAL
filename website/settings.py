...
SECRET_KEY = 'django-insecure-#mbg2i%(taf4+*_t-^4&b-nch#%==(&)j&1vq9$7-!m!))&2cq'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'app/user_views/static'),
]
